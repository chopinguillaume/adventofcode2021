...
public class Day04Test {
    ...
    private static Stream<Arguments> part1() {
        return Stream.of(
            Arguments.of("day04_test.txt", 4512),
            Arguments.of("day04.txt", null));
    }
    ...
    void part1(String filename, Integer expectedResult) {
        ...
        int actualResult = Day04.scoreOfWinningBoard(inputValues);
    ...
    private static Stream<Arguments> part2() {
        return Stream.of(
            Arguments.of("day04_test.txt", 1924),
            Arguments.of("day04.txt", null));
    }
    ...
    void part2(String filename, Integer expectedResult) {
        ...
        int actualResult = Day04.scoreOfLastWinningBoard(inputValues);
